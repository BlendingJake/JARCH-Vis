...
from . jarch_utils import point_rotation, object_dimensions, round_tuple, METRIC_INCH, METRIC_FOOT, HI, I, \
    rot_from_normal
from . jarch_materials import glossy_diffuse_material, image_material
...
def update_roofing(self, context):
    ...
    if m_ob.ro_main_name == "none" and m_ob.ro_object_add == "convert" and len(m_ob.face_groups) >= 1:
        ...
        roof_data = [use_ob.ro_object_add, use_ob.ro_mat, use_ob.ro_shingles, use_ob.ro_tin, use_ob.ro_res,
                     use_ob.ro_tile_radius]
    ...
    if use_ob.ro_object_add == "convert" and obs != []:
        ...
        for o_name in obs:
            ...
            new_ob = create_roofing(context, roof_data[0], roof_data[1], roof_data[2], roof_data[3], xy_dim * 1.1,
                                    z_dim * 1.1, o.pl_pitch, roof_data[4], roof_data[5])
    ...
    if m_ob.ro_object_add == "add":
        ...
        # create new object
        create_roofing(context, m_ob.ro_object_add, m_ob.ro_mat, m_ob.ro_shingles, m_ob.ro_tin,
                       m_ob.ro_length, m_ob.ro_width, m_ob.ro_slope, m_ob.ro_res, m_ob.ro_tile_radius)
        ...
        if area.type == 'VIEW_3D':
            for space in area.spaces:
                if space.type == 'VIEW_3D':
                    if bpy.context.object.ro_is_preview:
...
def roofing_material(self):
    ...
    if o.ro_col_image == "" and o.ro_mat in ("2", "3"): 
        ...
        return
    if o.ro_is_bump and o.ro_norm_image == "" and o.ro_mat in ("2", "3"):
        self.report({"ERROR"}, "No Normal Map Image Entered")
        return

    if o.ro_mat == "1":
        mat = glossy_diffuse_material(bpy, o.ro_color, (1.0, 1.0, 1.0), 0.18, 0.05, "roofing_use")
    else:
        mat = image_material(bpy, o.ro_im_scale, o.ro_col_image, o.ro_norm_image, o.ro_bump_amo, o.ro_is_bump,
                             "roofing_use", True, 0.1, 0.05, o.ro_is_rotate, None)
...
bpy.types.Object.group_index = IntProperty(default=0, update=update_selection)

# planes info
bpy.types.Object.pl_z_rot = FloatProperty(unit="ROTATION", name="Object Z Rotation")
bpy.types.Object.pl_pitch = FloatProperty(min=1.0, max=24.0, default=4.0, name="Pitch X/12")

# overall
bpy.types.Object.ro_main_name = StringProperty(default="none")
bpy.types.Object.ro_object_add = StringProperty(default="none", update=update_roofing)
bpy.types.Object.ro_mat = EnumProperty(name="Material", items=(("1", "Tin", ""), ("2", "Shingles", ""),
                                                               ("3", "Terra Cotta", "")), update=update_roofing)
bpy.types.Object.ro_shingles = EnumProperty(name="Shingle Style", items=(("1", "Architectural", ""),
                                                                         ("2", "3-Tab", "")), update=update_roofing)
bpy.types.Object.ro_tin = EnumProperty(name="Tin Type", items=(("1", "Normal", ""), ("2", "Angular", ""),
                                                               ("3", "Standing Seam", "")), update=update_roofing)
bpy.types.Object.ro_length = FloatProperty(name="Overall Length", min=4 / METRIC_FOOT, max=100 / METRIC_FOOT,
                                           default=24 / METRIC_FOOT, subtype="DISTANCE", update=update_roofing)
bpy.types.Object.ro_width = FloatProperty(name="Overall Width", min=4 / METRIC_FOOT, max=80 / METRIC_FOOT,
                                          default=12 / METRIC_FOOT, subtype="DISTANCE", update=update_roofing)
bpy.types.Object.ro_slope = FloatProperty(name="Slope (X/12)", min=1.0, max=12.0, default=4.0, update=update_roofing)
bpy.types.Object.ro_mirror = BoolProperty(name="Mirror?", default=True, update=update_roofing)

bpy.types.Object.ro_res = IntProperty(name="Curve Resolution", min=3, max=10, default=5, update=update_roofing)
bpy.types.Object.ro_tile_radius = FloatProperty(name="Tile Radius", min=1.5 / METRIC_INCH, max=3.0 / METRIC_INCH,
                                                default=2.0 / METRIC_INCH, update=update_roofing, subtype="DISTANCE")

# materials
bpy.types.Object.ro_is_material = BoolProperty(name="Cycles Materials?", default=False,
                                               description="Adds Cycles Materials", update=delete_materials)
bpy.types.Object.ro_is_preview = BoolProperty(name="Preview Material?", default=False,
                                              description="Preview Material On Object", update=preview_materials)
bpy.types.Object.ro_im_scale = FloatProperty(name="Image Scale", max=10.0, min=0.1, default=1.0,
...
bpy.types.Object.ro_norm_image = StringProperty(name="", subtype="FILE_PATH",
                                                description="File Path For Normal Map Image")
bpy.types.Object.ro_bump_amo = FloatProperty(name="Normal Stength", min=0.001, max=2.000, default=0.250,
                                             description="Normal Map Strength")
bpy.types.Object.ro_unwrap = BoolProperty(name="UV Unwrap?", default=False, description="UV Unwraps Siding",
                                          update=unwrap_roofing)
bpy.types.Object.ro_is_rotate = BoolProperty(name="Rotate Image?", default=False, description="Rotate Image 90 Degrees")
bpy.types.Object.ro_random_uv = BoolProperty(name="Random UV's?", default=True, description="Random UV's",
                                             update=update_roofing)
bpy.types.Object.ro_color = FloatVectorProperty(name="Tin Color", subtype="COLOR", default=(1.0, 1.0, 1.0), min=0.0,
...
class RoofingPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if ob is not None:
            if True:  # ob.object_add == "none" and ob.s_object_add == "none" and ob.f_object_add == "none":
                ...
                if (context.mode == "OBJECT" and len(ob.face_groups) >= 1 and ob.ro_object_add == "convert") or \
                        ob.ro_object_add == "add":

                    if True:  # ob.ro_object_add != "convert":
                    ...
                    if ob.ro_is_material and context.scene.render.engine == "CYCLES":
                        layout.separator()
                        if ob.ro_mat == "1":  # tin
