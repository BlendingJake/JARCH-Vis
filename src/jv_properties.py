...
def jv_on_face_group_index_update(_, context: Context):
    ...
    if 0 <= props.face_groups_index < len(props.face_groups):
        indices = set(
            int(i)
            for i in props.face_groups[props.face_groups_index].face_indices.split(",")
        )
...
class Cutout(PropertyGroup):
    location: FloatVectorProperty(
        ...
        subtype="TRANSLATION",
        size=3,
        description="The position of the lower-bottom-left corner",
    ...
    rotation: FloatVectorProperty(
        ...
        subtype="EULER",
        size=3,
        description="The rotation of the cutout",
        update=jv_on_property_update,
    )

    dimensions: FloatVectorProperty(
        name="Dimensions",
        default=(Units.FOOT, Units.FOOT, Units.FOOT),
        step=1,
        precision=3,
        unit="LENGTH",
        size=3,
        min=0.0,
        description="The the dimensions of the cutout",
        update=jv_on_property_update,
    )
...
class JVProperties(PropertyGroup):
    object_type: EnumProperty(
        ...
        default="none",
        description="The type of architecture to build",
        update=jv_on_property_update,
    )
    ...
    update_automatically: BoolProperty(
        ...
        default=True,
        description="Update the mesh anytime a property is changed?",
        update=jv_on_property_update,
    )

    convert_source_object: PointerProperty(name="Convert Source Object", type=Object)
    ...
    length: FloatProperty(
        name="Total Length",
        min=0.5 * Units.FOOT,
        default=20 * Units.FOOT,
        precision=4,
        subtype="DISTANCE",
        description="Total length of material",
        update=jv_on_property_update,
    )
    ...
    width: FloatProperty(
        name="Total Width",
        min=0.5 * Units.FOOT,
        default=8 * Units.FOOT,
        precision=4,
        subtype="DISTANCE",
        description="Total width of material",
        update=jv_on_property_update,
    )
    ...
    height: FloatProperty(
        ...
        precision=3,
        subtype="DISTANCE",
        description="Total height of the material",
        update=jv_on_property_update,
    )
    ...
    add_cutouts: BoolProperty(
        name="Cutouts?",
        description="Add box cutouts for things like windows or doors?",
        update=jv_on_property_update,
    )

    cutouts: CollectionProperty(name="Cutouts", type=Cutout)

    # OBJECT STYLES ------------------------------------------------------------------------------
    face_groups: CollectionProperty(name="Face Groups", type=FaceGroup)
    ...
    board_width_wide: FloatProperty(
        name="Board Width",
        min=1 * Units.INCH,
        default=8 * Units.INCH,
        subtype="DISTANCE",
        description="The width of each board",
        update=jv_on_property_update,
    )
    ...
    vary_width: BoolProperty(
        name="Vary Width?",
        default=False,
        description="Vary the width of each board?",
        update=jv_on_property_update,
    )
    ...
    width_variance: FloatProperty(
        ...
        default=25.00,
        subtype="PERCENTAGE",
        description="The width of each board will be in width +- width*variance",
        update=jv_on_property_update,
    )
    ...
    board_length_long: FloatProperty(
        ...
        precision=4,
        subtype="DISTANCE",
        description="The length of each board",
        update=jv_on_property_update,
    )
    ...
    vary_length: BoolProperty(
        name="Vary Length?",
        default=False,
        description="Vary the length of each board?",
        update=jv_on_property_update,
    )
    ...
    length_variance: FloatProperty(
        ...
        default=25.00,
        subtype="PERCENTAGE",
        description="The length of each board will be in length +- length*variance",
        update=jv_on_property_update,
    )
    ...
    thickness_thin: FloatProperty(
        name="Thickness",
        min=Units.ETH_INCH,
        default=5 * Units.STH_INCH,
        step=1,
        precision=4,
        subtype="DISTANCE",
        description="The thickness of each board, tile, shingle, etc.",
        update=jv_on_property_update,
    )
    ...
    thickness_thick: FloatProperty(
        name="Thickness",
        min=1 * Units.ETH_INCH,
        default=2.5 * Units.INCH,
        step=1,
        precision=3,
        subtype="DISTANCE",
        description="The thickness of each board, tile, shingle, etc.",
    ...
    vary_thickness: BoolProperty(
        name="Vary Thickness?",
        default=False,
        description="Vary the thickness of each board?",
        update=jv_on_property_update,
    )
    ...
    gap_uniform: FloatProperty(
        name="Gap",
        min=0.00,
        default=1 * Units.STH_INCH,
        subtype="DISTANCE",
        step=1,
        precision=5,
        description="The gap around each board or tile",
        update=jv_on_property_update,
    )
    ...
    gap_widthwise: FloatProperty(
        name="Gap - Widthwise",
        min=0.00,
        default=Units.ETH_INCH,
        subtype="DISTANCE",
        step=1,
        precision=4,
        description="The gap between the board or tile in the width direction",
        update=jv_on_property_update,
    )
    ...
    gap_lengthwise: FloatProperty(
        name="Gap - Lengthwise",
        min=0.00,
        default=Units.STH_INCH,
        subtype="DISTANCE",
        step=1,
        precision=4,
        description="The gap between the board or tile in the length direction",
        update=jv_on_property_update,
    )
    ...
    row_offset: FloatProperty(
        ...
        default=50.00,
        subtype="PERCENTAGE",
        description="How much alternating rows are offset",
        update=jv_on_property_update,
    )
    ...
    vary_row_offset: BoolProperty(
        ...
        default=False,
        description="Vary the offset of each row?",
        update=jv_on_property_update,
    )
    ...
    row_offset_variance: FloatProperty(
        ...
        default=50.00,
        subtype="PERCENTAGE",
        description="Each row will be offset between (width / 2) * (1 - variance)",
        update=jv_on_property_update,
    )
    ...
    add_grout: BoolProperty(
        name="Add Grout?",
        default=True,
        description="Add cube for where the grout/mortar would be?",
        update=jv_on_property_update,
    )
    ...
    grout_depth: FloatProperty(
        ...
        step=5,
        subtype="PERCENTAGE",
        description="The depth of the grout is depth*thickness",
        update=jv_on_property_update,
    )
    ...
    shake_width: FloatProperty(
        name="Shake Width",
        min=1 * Units.INCH,
        default=4 * Units.INCH,
        precision=4,
        step=1,
        subtype="DISTANCE",
        description="The width of each shake",
        update=jv_on_property_update,
    )
    ...
    shake_length: FloatProperty(
        ...
        step=2,
        subtype="DISTANCE",
        description="The length of each shake, the actual exposure will be length/2",
        update=jv_on_property_update,
    )
    ...
    scallop_resolution: IntProperty(
        ...
        min=1,
        default=8,
        description="The smoothness of the curve",
        update=jv_on_property_update,
    )
    ...
    tile_length: FloatProperty(
        ...
        default=8 * Units.INCH,
        subtype="DISTANCE",
        description="The length of each tile",
        update=jv_on_property_update,
    )
    ...
    checkerboard_board_count: IntProperty(
        ...
        min=1,
        default=4,
        description="Number of boards in each square of checkerboard pattern",
        update=jv_on_property_update,
    )
    ...
    with_dots: BoolProperty(
        name="With Dots?",
        default=True,
        description="Add cube between corners of hexagons?",
        update=jv_on_property_update,
    )
    ...
    side_length: FloatProperty(
        ...
        step=2,
        subtype="DISTANCE",
        description="The length of each side in the regular polygon",
        update=jv_on_property_update,
    )
    ...
    alternating_row_width: FloatProperty(
        ...
        step=2,
        subtype="DISTANCE",
        description="The width of the tiles in the alternating rows",
        update=jv_on_property_update,
    )
    ...
    slope_top: BoolProperty(
        name="Slope Top?",
        default=False,
        description="Cut a slope on the top of the siding?",
        update=jv_on_property_update,
    )
    ...
    pitch_offset: FloatVectorProperty(
        ...
        precision=3,
        subtype="TRANSLATION",
        description="Offset from the top-center of the siding for the slope",
        update=jv_on_property_update,
    )
    ...
    battens: BoolProperty(
        name="Add Battens?",
        default=False,
        description="Add battens to the siding to cover the gaps between boards?",
        update=jv_on_property_update,
    )

    batten_width: FloatProperty(
        name="Batten Width",
        default=2 * Units.INCH,
        min=0.5 * Units.INCH,
        subtype="DISTANCE",
        description="The width of the battens",
        update=jv_on_property_update,
    )
    ...
    batten_width_variance: FloatProperty(
        ...
        default=50.00,
        subtype="PERCENTAGE",
        description="Each batten's width will be in width +- (w * variance)",
        update=jv_on_property_update,
    )
    ...
    brick_length: FloatProperty(
        ...
        step=1,
        subtype="DISTANCE",
        description="The length of each brick",
        update=jv_on_property_update,
    )
    ...
    joint_left: BoolProperty(
        name="Joint Left?",
        default=False,
        description="Leave 'thickness + gap' overhang on odd rows to allow jointing?",
        update=jv_on_property_update,
    )
    ...
    joint_right: BoolProperty(
        name="Joint Right?",
        default=False,
        description="Leave 'thickness + gap' overhang on even rows to allow jointing?",
        update=jv_on_property_update,
    )
    ...
    pan_width: FloatProperty(
        ...
        step=1,
        subtype="DISTANCE",
        description="The width of each pan",
        update=jv_on_property_update,
    )
    ...
    terracotta_resolution: IntProperty(
        ...
        min=1,
        default=12,
        description="The resolution of the curve on the tile",
        update=jv_on_property_update,
    )
    ...
    terracotta_radius: FloatProperty(
        ...
        step=1,
        subtype="DISTANCE",
        description="The radius of the half-circle on the tile",
        update=jv_on_property_update,
    )
    ...
    terracotta_gap: FloatProperty(
        ...
        step=1,
        subtype="DISTANCE",
        description="The distance between the half-circles on the tiles",
        update=jv_on_property_update,
    )
    ...
    mirror: BoolProperty(
        name="Mirror?",
        default=False,
        description="Mirror roofing across X-axis?",
        update=jv_on_property_update,
    )
    ...
    jamb_width: FloatProperty(
        ...
        default=4 * Units.INCH,
        subtype="DISTANCE",
        description="The width of the jamb",
        update=jv_on_property_update,
    )
    ...
    frame_width: FloatProperty(
        ...
        default=1.5 * Units.INCH,
        subtype="DISTANCE",
        description="The width of the frame around the glass",
        update=jv_on_property_update,
    )
    ...
    frame_thickness: FloatProperty(
        ...
        precision=3,
        subtype="DISTANCE",
        description="The thickness of the frame surrounding the glass pane",
        update=jv_on_property_update,
    )
    ...
    window_width_medium: FloatProperty(
        name="Width",
        min=Units.FOOT,
        default=32 * Units.INCH,
        subtype="DISTANCE",
        description="The width of the windows",
        update=jv_on_property_update,
    )
    ...
    window_height_tall: FloatProperty(
        ...
        default=6 * Units.FOOT,
        subtype="DISTANCE",
        description="The height of the windows",
        update=jv_on_property_update,
    )
    ...
    window_height_medium: FloatProperty(
        ...
        default=4 * Units.FOOT,
        subtype="DISTANCE",
        description="The height of the gliding windows",
        update=jv_on_property_update,
    )
    ...
    num_joined_windows: IntProperty(
        name="Window Gang Count", min=1, default=1, update=jv_on_property_update
    )

    window_radius: FloatProperty(
        name="Radius",
        min=Units.FOOT,
        default=1.5 * Units.FOOT,
        subtype="DISTANCE",
        description="The radius of the window",
        update=jv_on_property_update,
    )

    window_side_count: IntProperty(
        name="Sides", min=3, default=3, update=jv_on_property_update
    )

    full_circle: BoolProperty(
        name="Full Circle?", default=True, update=jv_on_property_update
    )
    ...
    window_resolution: IntProperty(
        name="Resolution", min=10, default=64, step=2, update=jv_on_property_update
    )

    slider: BoolProperty(name="Slider?", default=True, update=jv_on_property_update)
    ...
    bow_segments: IntProperty(
        name="Segments", min=2, default=5, update=jv_on_property_update
    )
